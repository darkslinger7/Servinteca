<?php
// Script para buscar productos por nombre
...
if (isset($_GET['nombre'])) {
    $nombre_buscado = '%' . limpiar($_GET['nombre']) . '%'; // Buscar coincidencias parciales

    $resultados = [];

    // Buscar en la tabla 'maquinas'
